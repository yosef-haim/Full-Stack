        ...
        <form onSubmit={authSubmitHandler} className="place-form">
          {!isLoginMode && (
            <Input
              ...
              errorText="Pleaase eneter a name."
              onInput={inputHandler}
            />
          )}
          {!isLoginMode && (
            <ImageUpload center id="image" onInput={inputHandler} errorText="Please prvide an image." />
          )}
          <Input
            element="input"
            id="email"
          ...
          <Input
            ...
            errorText="please eneter a valid password, at least 6 characters."
            onInput={inputHandler}
          />
